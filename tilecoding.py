def tiling(state):
    ...
    memct = 48  # memory for hashtable (Tile "size")
...
#----------------------------------------------------------------------------------------------------
#This codification was originally published at: http://rlai.cs.ualberta.ca/RLAI/RLtoolkit/tiles.html
#----------------------------------------------------------------------------------------------------
"""
Tiling routines
...
def hashUNH(ints, numInts, m, increment=449):
    ...
    # res = reduce(operator.add, [_randomTable[(ints[i] + i*increment) & 2047] for i in range(numInts)])
